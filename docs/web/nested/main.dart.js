...
C.jB=I.e([C.fy])
C.k1=I.e([C.S,C.k])
C.jF=I.e([C.w,C.hu,C.hq,C.u,C.aj,C.d4,C.d5,C.jB,C.dd,C.k1,C.o,C.P,C.Y])
C.jG=I.e(["number","tel"])
C.bC=H.k("ho")
C.k3=I.e([C.bC,C.k])
...
C.jI=I.e([C.i4])
C.jK=I.e([C.bm,C.ak])
C.jL=I.e(["._nghost-%COMP% { display:block; width:100%; height:100%; } .container._ngcontent-%COMP% { width:900px; height:500px; background-color:black; } .panel1._ngcontent-%COMP% { width:100%; height:calc((100% - 7px) / 2); display:flex; flex-direction:row; } .panel2._ngcontent-%COMP% { height:100%; width:calc((100% - 14px) / 3); }"])
...
C.kf=I.e([C.j0])
C.ji=H.P(I.e([]),[P.ea])
C.c_=new H.oW(0,{},C.ji,[P.ea,null])
